 ...
 */
Raphael.fn.connectionnew = function (obj1, obj2, style) {
    var selfRef = this;
    /* create and return new connection */
    var color = style; //style.fg || "#FFF";
    var edge = {/*
        from : obj1,
        to : obj2,
        style : style,*/
...
Raphael.fn.removeconnections = function (obj1, obj2, line, bg) {
    if (obj1.line && obj1.from && obj1.to) {
        line = obj1;
        obj1 = line.from;
        obj2 = line.to;
    ...
    if (line && line.line) {
        ...
        var color = typeof line == "string" ? line : "#000";
        return {
            bg: bg && bg.split && this.path(path).attr({stroke: bg.split("|")[0], fill: "none", "stroke-width": bg.split("|")[0] || 0}),
            line: this.path(path).attr({x:0, y:0, display:'none'}),
            from: obj1,
            to: obj2
        };
    }
